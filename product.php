    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productNumber" placeholder="Product Number" name="productNumber" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
				    	...
				    	<div class="form-group">
			        	<label for="editProductNumber" class="col-sm-3 control-label">Product Number: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editProductNumber" placeholder="Product Number" name="editProductNumber" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	    
