...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(productNumber == "") {
				$("#productNumber").after('<p class="text-danger">Product Number field is required</p>');
				$('#productNumber').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#productNumber").find('.text-danger').remove();
				// success out for form 
				$("#productNumber").closest('.form-group').addClass('has-success');	  	
			}	// /else
	...
	if(productId) {
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				// product number
				$("#editProductNumber").val(response.product_number);
				// product name
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					var productNumber = $("#editProductNumber").val();
					...
					if(productNumber == "") {
						$("#editProductNumber").after('<p class="text-danger">Product Number field is required</p>');
						$('#editProductNumber').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#editProductNumber").find('.text-danger').remove();
						// success out for form 
						$("#editProductNumber").closest('.form-group').addClass('has-success');	  	
					}	// /else
